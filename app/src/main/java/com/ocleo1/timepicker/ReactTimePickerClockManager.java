...
public class ReactTimePickerClockManager extends SimpleViewManager<TimePicker>{

    public static final String REACT_CLASS = "ClockTimePickerAndroid";
    ...
    protected TimePicker createViewInstance(ThemedReactContext reactContext) {
        ...
        return (TimePicker) LayoutInflater.from(reactContext).inflate(R.layout.time_picker_clock, null);
    }
